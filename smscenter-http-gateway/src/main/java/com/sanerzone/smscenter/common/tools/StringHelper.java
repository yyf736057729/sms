...
public class StringHelper extends org.apache.commons.lang3.StringUtils {
	...
	public static boolean haswidthChar(String content) {
		if (StringHelper.isEmpty(content))return false;
    ...
    //获取手机号码列表
    public static List<String> queryTextPhone(String txtPhone,String regex){
    	List<String> phoneList = Lists.newArrayList();
    	if(StringHelper.isBlank(txtPhone)){
    		return phoneList;
    	}
	...
	//获取扣费条数
	public static int findPayCount(String smsContent){
		SmsTextMessage sms = null;
		if(StringHelper.haswidthChar(smsContent)) {
