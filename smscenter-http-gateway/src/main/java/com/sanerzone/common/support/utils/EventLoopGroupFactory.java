...
import com.sanerzone.common.support.config.SysConfig;
...
public enum EventLoopGroupFactory {
	...
	private final static ListeningScheduledExecutorService busiWork = MoreExecutors.listeningDecorator(new ScheduledThreadPoolExecutor(SysConfig.getConfig().getInt("GlobalBusiWorkThreadCount", 4),newThreadFactory("busiWork-"),rejected));
