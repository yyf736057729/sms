...
public class GateWayMTListener implements MessageListener
{
    ...
    public Action consume(Message message, ConsumeContext consumeContext) {
        Result result = null;
        logger.info("ums listener recv mt, topic:{}, tag:{}, msgid:{}, key:{}", message.getTopic(), message.getTag(), message.getMsgID(), message.getKey());
...
//        {
//            logger.info("ums listener recv mt, topic:{}, tag:{}, msgid:{}, key:{}", message.getTopic(), message.getTags(), message.getMsgId(), message.getKeys());
//            SmsMtMessage smsMtMessage = null;
//
//            try
//            {
