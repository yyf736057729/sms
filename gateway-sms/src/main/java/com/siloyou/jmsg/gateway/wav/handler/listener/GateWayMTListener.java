package com.siloyou.jmsg.gateway.wav.handler.listener;
...
public class GateWayMTListener implements MessageListener
{
    ...
    public Action consume(Message message, ConsumeContext context) {
        Result result = null;
        logger.info("wav listener recv mt, topic:{}, tag:{}, msgid:{}, key:{}", message.getTopic(), message.getTag(), message.getMsgID(), message.getKey());
...
//        {
//            logger.info("wav listener recv mt, topic:{}, tag:{}, msgid:{}, key:{}", message.getTopic(), message.getTags(), message.getMsgId(), message.getKeys());
//            SmsMtMessage smsMtMessage = null;
//            try
//            {
//                smsMtMessage = (SmsMtMessage)FstObjectSerializeUtil.read(message.getBody());
