...
public class SGIPSubmitRepMessage extends SGIPMessage
{
	...
	{
		return String.valueOf(super.src_node_Id)
				+ String.valueOf(super.time_Stamp)
				+ String.valueOf(super.sequence_Id);
	}
    ...
    public String toString() {
        ...
        tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
                .valueOf(tmpStr)))).append("SequenceNumber=").append(getSubmitSequenceNumberStr())));
        tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
