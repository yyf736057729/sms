...
package com.sanerzone.smscenter.gateway.sgip.comm.sgip.message;

import com.sanerzone.smscenter.gateway.sgip.comm.sgip.SGIPConstant;
import com.sanerzone.smscenter.gateway.sgip.util.TypeConvert;
...
public class SGIPReportMessage extends SGIPMessage
{
	...
	{
		return (String.valueOf(getSubmitSequenceNumber()[0])
				+ String.valueOf(getSubmitSequenceNumber()[1])
				+ String.valueOf(getSubmitSequenceNumber()[2])).toLowerCase();
	}
    ...
    public String toString()
    {
        ...
        tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",SubmitSequenceNumber=").append(getSubmitSequenceNumberStr())));
