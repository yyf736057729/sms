...
import com.sanerzone.smscenter.gateway.sgip.comm.PEvent;
...
import com.sanerzone.smscenter.gateway.sgip.util.WatchThread;
...
public abstract class SGIPSocketConnection extends PLayer
{
        ...
        class ReceiveThread extends WatchThread
        {
            ...
            public void task()
            {
                try
                {
                	...
                	System.out.println("task socketexception:" + ExceptionUtils.getStackTrace(socketexception));
                	close();
                }
    ...
    public void setAttributes(Args args)
    {
        ...
        reconnectInterval = 1000 * args.get("reconnect-interval", 0);
        if(socket != null)
            try
            {
