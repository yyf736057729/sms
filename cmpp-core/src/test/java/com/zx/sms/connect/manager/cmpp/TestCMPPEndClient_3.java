...
public class TestCMPPEndClient_3 {
	private static final Logger logger = LoggerFactory.getLogger(TestCMPPEndClient_3.class);
	...
	public void testCMPPEndpoint() throws Exception {
		...
		client.setUserName("350114");
		client.setPassword("350114");
