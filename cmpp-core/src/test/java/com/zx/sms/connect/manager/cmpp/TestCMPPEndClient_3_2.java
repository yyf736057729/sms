...
public class TestCMPPEndClient_3_2 {
	private static final Logger logger = LoggerFactory.getLogger(TestCMPPEndClient_3_2.class);
	...
	public void testCMPPEndpoint() throws Exception {
		...
		client.setGroupName("350115");
		client.setUserName("350115");
		client.setPassword("350115");
