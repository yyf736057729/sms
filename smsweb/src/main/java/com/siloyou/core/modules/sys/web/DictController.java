...
import com.siloyou.core.modules.sys.service.DictService;
...
public class DictController extends BaseController {
	...
	public String save(Dict dict, Model model, RedirectAttributes redirectAttributes) {
		...
		dict.setLabel(dict.getLabel().replaceAll("&lt;br&gt;", "<br>"));//页面中录入的<br>被转义了, 再转回来
		dict.setRemarks(dict.getRemarks().replaceAll("&lt;br&gt;", "<br>"));//页面中录入的<br>被转义了, 再转回来
