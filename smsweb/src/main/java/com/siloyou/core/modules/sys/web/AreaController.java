...
import com.siloyou.core.modules.sys.service.AreaService;
...
//            Area area1 = UserUtils.getUser().getOffice().getArea();
            User user = UserUtils.getUser();
            Office office = user.getOffice();
            Area area1 = null;
            if(office != null){
                 area1 = office.getArea();
            }
        ...
        area.setParent(areaService.get(id));
//		// 自动获取排序号
