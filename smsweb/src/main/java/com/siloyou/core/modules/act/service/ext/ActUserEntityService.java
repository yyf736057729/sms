 ...
 */
package com.siloyou.core.modules.act.service.ext;
...
import com.siloyou.core.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.siloyou.core.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.siloyou.core.modules.sys.entity.User(null, userId)))){
