...
public class EmailUtil {
    ...
    public static void main(String[] args){
        ...
        EmailUtil email = new EmailUtil("smtp.exmail.qq.com", 465, 0, true, "xurui@xxx.com","shoQ0qGY3TVMzLZ7",true);
        try{
            email.sendEmail(
                    "xurui@xxx.com",
                    "企业彩秀",
                    "316175992@qq.com",
                    "彩信审核通知",
                    "<html><body><font color='red'>您有待审彩信，主题: 测试彩信 ,请登录<a href=\"http://114.55.90.98:8800/\">企业彩秀平台</a>进行审核。</font></body></html>",
                    null);
     ...
     * @see [类、类#方法、类#成员]
     */
    public static void CheckSmssendEmail(String content)
    {
    	sendEmail("短信审核通知", content);
    }
    ...
    {
    	String mailHost = DictUtils.getDictLabel("mail_host","mailsend_param","smtp.exmail.qq.com");
    	String mailPort = DictUtils.getDictLabel("mail_port","mailsend_param","465");
    	String account = DictUtils.getDictLabel("account","mailsend_param","xurui@xxx.com");
    	String password = DictUtils.getDictLabel("password","mailsend_param","");
    	String senderName = DictUtils.getDictLabel("senderName","mailsend_param","泛圣短信平台");
        EmailUtil email = new EmailUtil(mailHost, Integer.parseInt(mailPort), 0, true, account, password, true);
        try
        {
            ...
            email.sendEmail(account,
            	senderName,
                toAddress.toString(), //"guorui_xu@qq.com,7552551@qq.com,447212972@qq.com,13666672546@139.com",
                "【" + senderName + "】" + title,
                "<html><body><font color='red'>" + content + ",请登录平台进行处理。</font></body></html>",
                null);
            System.out.println("send out successfully");
        }
        catch (Exception ex)
