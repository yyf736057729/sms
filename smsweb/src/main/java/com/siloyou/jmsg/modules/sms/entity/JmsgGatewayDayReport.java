 ...
 * @version 2016-08-04
 */
public class JmsgGatewayDayReport extends DataEntity<JmsgGatewayDayReport> {
	
	private static final long serialVersionUID = 1L;
	private Date day;						// 统计日期
	...
	public JmsgGatewayDayReport() {
		super();
	}

	public JmsgGatewayDayReport(String id){
		super(id);
	}
