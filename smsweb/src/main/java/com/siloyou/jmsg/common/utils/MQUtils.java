...
//	private static DefaultMQProducer smsMTProducer;

	private static Producer smsCenterProducer;
	private static Producer smsMTProducer;
	...
	public Producer geSmsCenterProducer() {
		if (smsCenterProducer == null) {
			smsCenterProducer = MQProducerFactory.getMQProducer("GID_"+appCode + "SMSCENTERGroup",
	...
	public String sendSmsSR(String bizid, byte[] body) {
		return sendMQ(smsCenterProducer, CacheKeys.getSmsSubmit(), bizid, bizid, body);
	}
