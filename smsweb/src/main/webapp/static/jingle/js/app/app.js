    ...
    var run = function(){
        ...
        Jingle.launch({
            ...
            remotePage : {
            	...
            	'#mms_checklist_section': ctx + '/mms/jmsgMmsData/checkList',
            	'#mms_view_section': ctx + '/mms/jmsgMmsData/form',
            	'#mms_taskreport_section': ctx + '/mms/jmsgMmsAlldayReport/reportBylist',
            	'#mms_task_section': ctx + '/mms/jmsgMmsTask/list',
            	'#sms_warnlist_section': ctx + '/sms/jmsgSmsWarn/warnList'
            }
        });
