...
<body>
	<ul class="nav nav-tabs">
		...
		<!--<shiro:hasPermission name="jmsg:admin"><li class="active"><a href="${ctx}/account/jmsgAccount/rechargeInit">彩信账户充值</a></li></shiro:hasPermission>-->
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="user.id" class="input-xlarge required">
					...
					<form:options items="${fns:getAccountList('mms')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="appType" class="input-xlarge required">
					<form:option value="mms" label="彩信"/>
