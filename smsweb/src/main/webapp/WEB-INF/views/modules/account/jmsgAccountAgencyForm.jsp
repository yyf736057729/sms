...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/account/jmsgAccount/agencyList">信息列表</a></li>
		<li class="active"><a href="${ctx}/account/jmsgAccount/agencyForm?id=${jmsgAccount.id}">信息<shiro:hasPermission name="account:jmsgAccount:edit">${not empty jmsgAccount.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="account:jmsgAccount:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="jmsgAccount" action="${ctx}/account/jmsgAccount/agencySave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
