...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			if(n) $("#pageNo").val(n);
			if(s) $("#pageSize").val(s);
			$("#searchForm").attr("action","${ctx}/sms/jmsgSmsDayReport/allDayExport");
			$("#searchForm").submit();
        	return false;
        }	
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sms/jmsgSmsDayReport/allDayExport">信息列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="jmsgSmsDayReport" action="${ctx}/sms/jmsgSmsDayReport/allDayExport" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>运营商：</label>
				<form:select path="phoneType" cssClass="input-medium">
