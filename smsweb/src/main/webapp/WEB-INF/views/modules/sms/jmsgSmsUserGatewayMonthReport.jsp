...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			if(n) $("#pageNo").val(n);
			if(s) $("#pageSize").val(s);
			$("#searchForm").attr("action","${ctx}/sms/jmsgSmsDayReport/listByUserGateway?queryType=month");
			$("#searchForm").submit();
        	return false;
        }	
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sms/jmsgSmsDayReport/listByUserGateway?queryType=month">信息列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="jmsgSmsDayReport" action="${ctx}/sms/jmsgSmsDayReport/listByUserGateway?queryType=month" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>用户ID：</label>
				<form:input path="userId" maxlength="10" cssClass="input-medium"/>
			</li>
			<li><label>通道ID：</label>
