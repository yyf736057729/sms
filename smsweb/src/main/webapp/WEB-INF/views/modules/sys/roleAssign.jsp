...
<body>
	...
	<div class="container-fluid breadcrumb">
		<div class="row-fluid span12">
			...
			<span class="span4">归属公司: ${role.companyName}</span>
		...
		<script type="text/javascript">
			$("#assignButton").click(function(){
				top.$.jBox.open("iframe:${ctx}/sys/role/usertorole?id=${role.id}", "分配角色",810,$(top.document).height()-240,{
					buttons:{"确定分配":"ok", "清除已选":"clear", "关闭":true}, bottomText:"通过选择公司，然后为列出的人员分配角色。",submit:function(v, h, f){
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>归属公司</th><!-- <th>归属部门</th> --><th>用户名</th><th>联系人</th><th>电话</th><th>手机</th><shiro:hasPermission name="sys:user:edit"><th>操作</th></shiro:hasPermission></tr></thead>
		<tbody>
