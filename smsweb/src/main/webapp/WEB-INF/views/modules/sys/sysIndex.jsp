...
<!-- 	<style type="text/css">
		...
		#header {margin:0 0 8px;position:static;} #header li {font-size:14px;_font-size:12px;}
 		/* #header .brand {font-family:Helvetica, Georgia, Arial, sans-serif, 黑体;font-size:26px;padding-left:33px;background: url(/static/images/top.png) no-repeat 30px 5px;width: 210px;}	
		#header .brand {font-family:Helvetica, Georgia, Arial, sans-serif, 黑体;font-size:26px;padding-left:33px;text-indent: -99999px;}*/
		#header .brand {font-family: Helvetica, Georgia, Arial, sans-serif, 黑体;font-size: 26px;padding-left: 0;text-indent: -99999px; background: url(/static/style/sms/images/logo_index.png) no-repeat 30px 8px;
	...
	<style type="text/css">
		...
		#header .brand {font-family:Helvetica, Arial, sans-serif, 黑体;font-size:26px;padding-left:33px;line-height: 24px;height: 24px;padding-top: 14px;padding-bottom: 0;min-width: 78px;}
		#header .brand span {display: block;float: left;}
		.header_name_big {font-weight: 400;}
		.header_name_line {margin: -2px 5px 0;font-size: 24px;}
		.header_name_small {font-size: 20px;padding-top: 1px;}
		#footer {margin:8px 0 0 0;padding:3px 0 0 0;font-size:11px;text-align:center;border-top:2px solid #0663A2;}
		...
		.container-fluid {padding: 0 4px 0 6px;}
	</style>
	<script type="text/javascript">
		$(document).ready(function() {
			...
			function getNotifyNum(){
				$.get("${ctx}/mms/jmsgMmsData/checkCount?t="+new Date().getTime(),function(data){
		...
		function addTabChild(id, title, url){
			$(".jericho_tab").show();
			$("#mainFrame").hide();
			$.fn.jerichoTab.addTab({
                //tabFirer: id,
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"><span class="header_name_big">泛圣</span><span class="header_name_line"> | </span><span class="header_name_small">短信运营开放平台</span></div>
				<ul id="userControl" class="nav pull-right">
					...
					<li id="userInfo" class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<shiro:hasPermission name="mms:jmsgMmsData:check">
							<li><a href="${ctx}/mms/jmsgMmsData/checkList" target="mainFrame"><i class="icon-bell"></i>&nbsp;  我的通知 <span id="notifyNum2" class="label label-info hide"></span></a></li>
							</shiro:hasPermission>
						</ul>
					</li>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	           <%--  Copyright &copy; 2015-${fns:getConfig('copyrightYear')} 全网短信网关能力开放平台 ${fns:getConfig('version')} --%>
	           Copyright &copy; 2015-<script>document.write((new Date()).getFullYear());</script> <b>杭州泛圣科技有限公司</b> All Rights Reserved.
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
