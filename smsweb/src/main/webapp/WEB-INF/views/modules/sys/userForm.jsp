...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<form:hidden path="noCheck"/>
		<form:hidden path="apikey"/>
		<form:hidden path="whiteIP"/>
		<form:hidden path="mmsfrom"/>
		<form:hidden path="upUrl"/>
		<form:hidden path="signFlag"/>
		<form:hidden path="groupId"/>
		<form:hidden path="keyword"/>
		<form:hidden path="filterWordFlag"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<form:input path="loginName" htmlEscape="false" maxlength="50" class="required userName" readonly="${not empty user.id && user.id !='' ?'true':'false'}"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<!-- <div class="control-group">
			...
			<div class="controls">
				<form:input path="mmsfrom" htmlEscape="false" maxlength="12" id="mmsfrom"/>
			</div>
		</div> -->		
		...
		<div class="control-group">
			<label class="control-label">上行地址:</label>
			<div class="controls">
				<form:input path="upUrl" htmlEscape="false" maxlength="100" id="upUrl"/>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<c:if test="${currentUser.id ne 1}">
					<form:checkboxes path="roleIdList" items="${commonUser}" itemLabel="name" itemValue="id" htmlEscape="false" class="required"/>
				</c:if>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
