...
<body>
	...
	<form:form id="inputForm" modelAttribute="dict" action="${ctx}/sys/dict/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="label" htmlEscape="true" rows="13" maxlength="1024" class="input-xlarge"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="remarks" htmlEscape="true" rows="13" maxlength="1024" class="input-xlarge"/>
			</div>
		</div>
